...
; wBookwormBooksRead::
	const_def
	const BOOKWORM_BOOKS_READ_1_F
	const BOOKWORM_BOOKS_READ_2_F
	const BOOKWORM_BOOKS_READ_3_F
	const BOOKWORM_BOOKS_READ_4_F
	const BOOKWORM_BOOKS_READ_5_F
	const BOOKWORM_BOOKS_READ_6_F
	const BOOKWORM_BOOKS_READ_7_F
	const BOOKWORM_BOOKS_READ_8_F

; wTaurosDefeated::
	const_def
	const DEFEATED_TAUROS_1_F
	const DEFEATED_TAUROS_2_F
	const DEFEATED_TAUROS_3_F
