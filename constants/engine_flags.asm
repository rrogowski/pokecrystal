...
; wBookwormBooksRead
	const ENGINE_READ_BOOKWORM_BOOK_1
	const ENGINE_READ_BOOKWORM_BOOK_2
	const ENGINE_READ_BOOKWORM_BOOK_3
	const ENGINE_READ_BOOKWORM_BOOK_4
	const ENGINE_READ_BOOKWORM_BOOK_5
	const ENGINE_READ_BOOKWORM_BOOK_6
	const ENGINE_READ_BOOKWORM_BOOK_7
	const ENGINE_READ_BOOKWORM_BOOK_8
; wTaurosDefeated
	const ENGINE_DEFEATED_TAUROS_1
	const ENGINE_DEFEATED_TAUROS_2
	const ENGINE_DEFEATED_TAUROS_3
