...
; Fisher
	...
	const EVENT_BEAT_FISHER_PAUL2
	const EVENT_BEAT_FISHER_JAKE2
; Twins
...
; Scientist
	...
	const EVENT_BEAT_SCIENTIST_AUSTIN
; Blackbelt
...
; PokefanM
	...
	const EVENT_BEAT_POKEFANM_MICHAEL2
; PokefanF
	...
	const EVENT_BEAT_POKEFANF_RILEY2
; Kimono Girl
	const_skip ; unused
...
; Lass
	...
	const EVENT_BEAT_LASS_TATIANA
	const EVENT_BEAT_LASS_BAILEY2
; Hiker
...
; New to Crystal
	...
	const EVENT_CHOSE_STARTER_CYNDAQUIL
	const EVENT_CHOSE_STARTER_TOTODILE
	const EVENT_CHOSE_STARTER_CHIKORITA
	const EVENT_RESCUED_YOUNGSTER
	...
	; sprite visibility flags
	const EVENT_ROCK_SALT_TOWN_JADE_INTRO
	const EVENT_ROCK_SALT_TOWN_JADE_BATTLING_TAUROS
	const EVENT_ROCK_SALT_TOWN_JADE_OUTSIDE_CAVE
	const EVENT_ROCK_SALT_TOWN_TAUROS
	const EVENT_ROCK_SALT_TOWN_TAUROS_RAMPAGING
	const EVENT_ROCK_SALT_TOWN_YOUNGSTER
	const EVENT_ROCK_SALT_TOWN_YOUNGSTER_TALKING_TO_OLD_MAN
	const EVENT_ROCK_SALT_TOWN_AIDE

	const EVENT_ROCK_SALT_LAB_PROF
	const EVENT_ROCK_SALT_LAB_AIDE_IN_FRONT
	const EVENT_ROCK_SALT_LAB_AIDE_IN_BACK
	const EVENT_ROCK_SALT_LAB_JADE_IN_FRONT
	const EVENT_ROCK_SALT_LAB_JADE_IN_BACK
	const EVENT_ROCK_SALT_LAB_CYNDAQUIL_IN_POKEBALL
	const EVENT_ROCK_SALT_LAB_TOTODILE_IN_POKEBALL
	const EVENT_ROCK_SALT_LAB_CHIKORITA_IN_POKEBALL
	const EVENT_ROCK_SALT_LAB_CYNDAQUIL
	const EVENT_ROCK_SALT_LAB_TOTODILE
	const EVENT_ROCK_SALT_LAB_CHIKORITA
	const EVENT_ROCK_SALT_LAB_CYNDAQUIL_WANDERING
	const EVENT_ROCK_SALT_LAB_TOTODILE_WANDERING
	const EVENT_ROCK_SALT_LAB_CHIKORITA_WANDERING
	const EVENT_ROCK_SALT_LAB_DEX

	const EVENT_ROCK_SALT_JADES_HOUSE_JADE

	const EVENT_ROCK_SALT_CAVE_1F_JADE

	const EVENT_ROCK_SALT_CAVERN_MONSTER
	const EVENT_ROCK_SALT_CAVERN_YOUNGSTER
	const EVENT_ROCK_SALT_CAVERN_PROF
	const EVENT_ROCK_SALT_CAVERN_JADE
	...
	; items
	const EVENT_ROCK_SALT_CAVE_1F_POTION
	const EVENT_ROCK_SALT_CAVE_1F_POKEBALL
	const EVENT_ROCK_SALT_CAVE_1F_NUGGET
	const EVENT_ROCK_SALT_CAVE_1F_TM_SPIKES
	const EVENT_ROCK_SALT_CAVE_1B_TM_SWIFT
