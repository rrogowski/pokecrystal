...
; New to Crystal
	...
	; story events
	const EVENT_JADE_CALLED_PLAYER_TO_ACTION
	const EVENT_ROCK_SALT_JADES_HOUSE_PLAYER_FACING_LEFT
	const EVENT_ROCK_SALT_JADES_HOUSE_PLAYER_FACING_UP
	const EVENT_JADE_LEFT_HOUSE
