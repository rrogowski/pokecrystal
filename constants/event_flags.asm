...
; New to Crystal
	...
	const EVENT_RECEIVED_DEX

	const EVENT_UNOWN_FIRST_ENCOUNTERED
	const EVENT_RECEIVED_SKETCHPAD

	; sprite visibility flags
	const EVENT_JADE_INTRO_IN_ROCK_SALT_TOWN
	const EVENT_JADE_BEHIND_LAB_IN_ROCK_SALT_TOWN
	const EVENT_JADE_BATTLING_TAUROS_IN_ROCK_SALT_TOWN
	const EVENT_AIDE_IN_ROCK_SALT_TOWN
	...
	const EVENT_JADE_IN_ROCK_SALT_JADES_HOUSE
	const EVENT_PROF_IN_ROCK_SALT_LAB
	const EVENT_AIDE_IN_ROCK_SALT_LAB
	const EVENT_JADE_IN_ROCK_SALT_LAB
