...
; pointers to the first map of each map group
	...
	dw MapGroup_RockSalt	; 27
	dw MapGroup_Peppercorn	; 28
...
MapGroup_Olivine:
	...
	map Route39Barn, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ROUTE_38, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route39Farmhouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_38, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map RockSaltCave1F, TILESET_CAVE, CAVE, LANDMARK_ROCK_SALT_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RockSaltCave1B, TILESET_CAVE, CAVE, LANDMARK_ROCK_SALT_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RockSaltCave2B, TILESET_CAVE, CAVE, LANDMARK_ROCK_SALT_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RockSaltCaveCavern, TILESET_CAVE, CAVE, LANDMARK_ROCK_SALT_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_RockSalt:
	table_width MAP_LENGTH
	map RockSaltTown, TILESET_JOHTO, TOWN, LANDMARK_ROCK_SALT_TOWN, MUSIC_PATIENT_IS_THE_NIGHT, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RockSaltPlayersHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_PATIENT_IS_THE_NIGHT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltJadesHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_PATIENT_IS_THE_NIGHT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltLab, TILESET_LAB, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_PATIENT_IS_THE_NIGHT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltBookwormsHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_PATIENT_IS_THE_NIGHT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltOldMansHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_PATIENT_IS_THE_NIGHT, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_ROCK_SALT_MAPS

MapGroup_Peppercorn:
	table_width MAP_LENGTH
	map Route101, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_101, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map PeppercornVillage, TILESET_JOHTO, TOWN, LANDMARK_PEPPERCORN_VILLAGE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	assert_table_length NUM_PEPPERCORN_MAPS