...
MapGroup_StarterTown:
	table_width MAP_LENGTH
	map StarterTownBookwormsHouse, TILESET_HOUSE, INDOOR, LANDMARK_STARTER_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map StarterTown, TILESET_JOHTO, TOWN, LANDMARK_STARTER_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
