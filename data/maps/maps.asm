...
MapGroup_RockSalt:
	table_width MAP_LENGTH
	map RockSaltTown, TILESET_JOHTO, TOWN, LANDMARK_ROCK_SALT_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RockSaltPlayersHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltRivalsHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltLab, TILESET_LAB, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltBookwormsHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map RockSaltOldMansHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROCK_SALT_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
